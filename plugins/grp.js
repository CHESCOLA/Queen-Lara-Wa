...
if (Config.WORKTYPE == 'private') {
        ...
        Chescola.addCMD({pattern: 'grp', fromMe: true, deleteCommand: false,}, (async (message, match) => {
...
if (Config.WORKTYPE == 'public') {
        ...
        Chescola.addCMD({pattern: 'grp', fromMe: false, deleteCommand: false,}, (async (message, match) => {
