...
# All rights reserved ©Queen lara @CHESCOLA KS t.me/Kasun
# Get more about devaoloper https://chescola.mlcy
*/
...
Chescola.addCMD({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
...
Chescola.addCMD({on: 'text', fromMe: true, deleteCommand: false}, (async (message, match) => {
...
Chescola.addCMD({pattern: 'afk ?(.*)', fromMe: true, deleteCommand: false, desc: Lang.AFK_DESC}, (async (message, match) => {     
    if (!AFK.isAfk) {
