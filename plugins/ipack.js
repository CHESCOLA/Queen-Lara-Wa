...
if (Config.WORKTYPE == 'private') {
    ...
    Chescola.addCMD({pattern: 'ipack', fromMe: true, deleteCommand: false, desc: I_DESC}, (async (message, match) => {
    ...
    Chescola.addCMD({pattern: 'sysd', fromMe: true, desc: Lang.SYSD_DESC,dontAddCMDList: true}, (async (message, match) => {
    ...
    Chescola.addCMD({ pattern: 'info', fromMe: true,deleteCommand: false,deleteCommand: false,desc: LW.PL_DESC,dontAddCMDList: true }, async (message, match) => { 
    ...
    Chescola.addCMD({ pattern: 'inf$', fromMe: true, desc: LW.PL_DESC, dontAddCMDList: true }, async (message, match) => { 
        if (message.jid.includes('-')) {
            var lasijson = await message.client.groupMetadataMinimal(message.jid) 
            var code = await message.client.groupInviteCode(message.jid)
            var nwjson = await message.client.groupMetadata(message.jid) 
    ...
    Chescola.addCMD({pattern: 'id ?(.*)', fromMe: true, desc: LP.JID_DESC, dontAddCMDList: true}, (async (message, match) => {    
    ...
    Chescola.addCMD({pattern: 'bot', fromMe: true, deleteCommand: false,}, (async (message, match) => {

	        var r_text = new Array ();

        r_text[1] = "https://i.ibb.co/ynWmP9z/20210720-181134.jpg";
        r_text[2] ="https://i.ibb.co/CP6d670/QUEEN-LARA-BOT.jpg";
        
        
var i = Math.floor(11*Math.random())
var lasiimage = await axios.get(`${r_text[i]}`, { responseType: 'arraybuffer' })
await message.client.sendMessage(message.jid, Buffer.from(lasiimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '                  *👸 𝕼𝖚𝖊𝖊𝖓 𝕷𝖆𝖗𝖆 👸* \n\n\n❍ 𝗛𝗼𝘀𝘁𝗲𝗱 ➤ 𝘼𝙒𝙎\n❍ 𝗩𝗲𝗿𝘀𝗶𝗼𝗻 ➤ 𝐕3.18'+Config.VERSION+'\n❍ 𝗕𝗿𝗮𝗻𝗰𝗵  ➤ *'+Config.BRANCH+'*\n❍ 𝗔𝗯𝗼𝘂𝘁    ➤ ᴄʜᴇsᴄᴏʟᴀ.𝙢𝙡\n❍ 𝗢𝘄𝗻𝗲𝗿   ➤𝙩.𝙢𝙚/𝙆𝙖𝙨𝙪𝙣\n❍ 𝗠𝗼𝗱𝗲𝗿𝘀 ➤┓\n                        ┣ @kasun077\n                        ┣ @lara\n                        ┣ @lucy_99X\n❍ 𝗠𝗮𝗶𝗻 𝗚𝗿𝗼𝘂𝗽 ➤ https://chat.whatsapp.com/CqO425i6m2NF7wEPkZtmcV\n\n⊱ ──────    ♔    ────── ⊰\n'})
    }));
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Chescola.addCMD({pattern: 'sysd', fromMe: false, desc: Lang.SYSD_DESC, dontAddCMDList: true}, (async (message, match) => {
    ...
    Chescola.addCMD({ pattern: 'info', fromMe: false,deleteCommand: false, desc: LW.PL_DESC , dontAddCMDList: true}, async (message, match) => { 
    ...
    Chescola.addCMD({ pattern: 'info', fromMe: true, desc: LW.PL_DESC, dontAddCMDList: true }, async (message, match) => { 
    ...
    Chescola.addCMD({ pattern: 'inf$', fromMe: false, desc: LW.PL_DESC, dontAddCMDList: true }, async (message, match) => { 
        if (message.jid.includes('-')) {
            var lasijson = await message.client.groupMetadataMinimal(message.jid) 
            var code = await message.client.groupInviteCode(message.jid)
            var nwjson = await message.client.groupMetadata(message.jid) 
    ...
    Chescola.addCMD({pattern: 'id ?(.*)', fromMe: false, desc: Lang.JID_DESC, dontAddCMDList: true}, (async (message, match) => {    
        if (message.reply_message !== false) {
    ...
    Chescola.addCMD({pattern: 'bot', fromMe: false, deleteCommand: false,}, (async (message, match) => {
