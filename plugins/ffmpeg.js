...
if (Config.WORKTYPE == 'private') {
    ...
    Chescola.addCMD({pattern: 'ffmpeg ?(.*)', fromMe: true, desc: Lang.FF_DESC}, (async (message, match) => {
    ...
    Chescola.addCMD({pattern: 'ffmpeg ?(.*)', fromMe: false, desc: Lang.FF_DESC, dontAddCMDList: true}, (async (message, match) => {
