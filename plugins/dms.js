...
Chescola.addCMD({pattern: 'dem ?(.*)', fromMe: true, desc: DDO,dontAddCMDList: true }, (async (message, match) => {    
...
Chescola.addCMD({pattern: 'fdem ?(.*)', fromMe: true, desc: DDO,dontAddCMDList: true }, (async (message, match) => {   
