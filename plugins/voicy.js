...
if (conf.WORKTYPE == 'private') {
    ...
    Chescola.addCMD({ pattern: 'voicy', desc: Lang.USAGE, fromMe: true }, (async (message, match) => {
...
if (conf.WORKTYPE == 'public') {
    ...
    Chescola.addCMD({ pattern: 'voicy', desc: Lang.USAGE, fromMe: false }, (async (message, match) => {
    ...
    Chescola.addCMD({ pattern: 'voicy', desc: Lang.USAGE, fromMe: true, dontAddCMDList: true }, (async (message, match) => {
