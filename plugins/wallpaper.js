...
if (Config.WORKTYPE == 'private') {
    ...
    Chescola.addCMD({pattern: 'wallpaper', fromMe: true, desc: Lang.WP}, (async (message, match) => {
    ...
    Chescola.addCMD({pattern: 'wallpaper', fromMe: false, desc: Lang.WP}, (async (message, match) => {
    ...
    Chescola.addCMD({pattern: 'wallpaper', fromMe: true, desc: Lang.WP, dontAddCMDList: true}, (async (message, match) => {
