...
if (Config.WORKTYPE == 'private') {
    Chescola.addCMD({ pattern: 'scan ?(.*)', fromMe: true, desc: Lang.SCAN}, (async (message, match) => { 
    ...
    Chescola.addCMD({ pattern: 'scan ?(.*)', fromMe: false, desc: Lang.SCAN}, (async (message, match) => { 
    ...
    Chescola.addCMD({ pattern: 'scan ?(.*)', fromMe: true, dontAddCMDList: true, desc: Lang.SCAN}, (async (message, match) => { 
