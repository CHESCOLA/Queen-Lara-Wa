...
if (Config.WORKTYPE == 'private') {
    ...
    Chescola.addCMD({pattern: 'tblend ?(.*)', fromMe: true, desc: Lang.T_DESC}, (async (message, match) => {    
    ...
    Chescola.addCMD({pattern: 'tblend ?(.*)', fromMe: false, desc: Lang.T_DESC}, (async (message, match) => {    
    ...
    Chescola.addCMD({pattern: 'tblend ?(.*)', fromMe: true, desc: Lang.T_DESC, dontAddCMDList: true}, (async (message, match) => {    
