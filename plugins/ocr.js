...
if (Config.WORKTYPE == 'private') {
    ...
    Chescola.addCMD({pattern: 'ocr ?(.*)', fromMe: true, desc: Lang.OCR_DESC}, (async (message, match) => { 
    ...
    Chescola.addCMD({pattern: 'ocr ?(.*)', fromMe: false, desc: Lang.OCR_DESC}, (async (message, match) => { 
    ...
    Chescola.addCMD({pattern: 'ocr ?(.*)', fromMe: true, desc: Lang.OCR_DESC, dontAddCMDList: true}, (async (message, match) => { 
