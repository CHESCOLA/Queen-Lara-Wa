...
if (Config.WORKTYPE == 'private') {
  ...
  Chescola.addCMD({pattern: 'net ?(.*)', desc: 'gives you the detail of your IP' ,fromMe: true}, async (message, match) => {
  ...
  Chescola.addCMD({pattern: 'net ?(.*)', desc: 'gives you the detail of your IP' ,fromMe: false}, async (message, match) => {
 ...
 Chescola.addCMD({pattern: 'net ?(.*)' ,fromMe: true,dontAddCMDList: true }, async (message, match) => {
