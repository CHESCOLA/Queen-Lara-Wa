...
if (Config.WORKTYPE == 'private') {
    ...
    Chescola.addCMD({pattern: 'neko', fromMe: true, desc: Lang.NEKO_DESC}, (async (message, match) => {
    ...
    Chescola.addCMD({pattern: 'neko', fromMe: false, desc: Lang.NEKO_DESC}, (async (message, match) => {
    ...
    Chescola.addCMD({pattern: 'neko', fromMe: true, desc: Lang.NEKO_DESC, dontAddCMDList: true}, (async (message, match) => {
