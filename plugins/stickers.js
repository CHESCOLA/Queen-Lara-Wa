...
if (Config.WORKTYPE == 'private') {
    Chescola.addCMD({pattern: 'sticker$', fromMe: true, desc: Lang.STICKER_DESC}, (async (message, match) => {    
        ...
        if (message.reply_message.video === false && message.reply_message.image) {
            ffmpeg(location)
                ...
                .videoFilters('scale=2000:2000:flags=lanczos:force_original_aspect_ratio=decrease,format=rgba,pad=2000:200p:(ow-iw)/2:(oh-ih)/2:color=#00000000,setsar=1')
                .save('st.webp')
                .on('end', async () => {
    ...
    Chescola.addCMD({pattern: 'sticker$', fromMe: false, desc: Lang.STICKER_DESC}, (async (message, match) => {    
    ...
    Chescola.addCMD({pattern: 'sticker$', fromMe: true, desc: Lang.STICKER_DESC, dontAddCMDList: true}, (async (message, match) => {    
