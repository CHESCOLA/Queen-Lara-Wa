...
if (Config.WORKTYPE == 'private') {
    ...
    Chescola.addCMD({pattern: 'a ?(.*)', fromMe: true, desc: Lang.UV_DESC}, (async (message, match) => {    
...
let id = match[1];
    ...
    Chescola.addCMD({pattern: 'unvoice', fromMe: true, desc: Lang.UV_DESC}, (async (message, match) => {    
    ...
    Chescola.addCMD({pattern: 'unvoice', fromMe: false, desc: Lang.UV_DESC}, (async (message, match) => {    
...
let id = match[1];
    ...
    Chescola.addCMD({pattern: 'unvoice', fromMe: true, desc: Lang.UV_DESC, dontAddCMDList: true}, (async (message, match) => {    
