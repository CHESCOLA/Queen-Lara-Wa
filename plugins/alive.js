...
await message.client.sendMessage(message.jid, Buffer.from(lara.data), MessageType.image, {mimetype: Mimetype.png, caption: '            '+Config.ALIVETEXT+'\n          ᴾᵒʷᵉʳᵈ ᵇʸ ᴄʜᴇsᴄᴏʟᴀ'})
    }));